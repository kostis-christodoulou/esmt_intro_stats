---
title: 'Intro Statistics and R Pre-programme Assignment'
...
You can find details on how to [install both R and R studio here](https://esmt-mim-intro-stats.netlify.app/reference/01-reference/)
...
You can find details on [installing the tidyverse here](https://esmt-mim-intro-stats.netlify.app/reference/02-reference)
...
brexit_results <- read_csv("https://raw.githubusercontent.com/kostis-christodoulou/esmt_intro_stats/master/data/brexit_results.csv")
